...
class MY_GUI():
    def __init__(self, init_window_name):
        ...
        self.LastStat = 'Start'
        self.PreloadInfo = StringVar(self.init_window_name, "not preload，quick_mode")
        ...
        self.luac = StringVar(self.init_window_name, "false")
    ...
    def set_init_window(self):
        ...
        self.RP_1 = Radiobutton(self.FM1, text='打开', variable=self.need_reference, value='true',
                                command=self.print_patch_reference).grid(row=13, column=1, sticky=NW)
        self.RP_2 = Radiobutton(self.FM1, text='关闭', variable=self.need_reference, value='false',
                                command=self.print_patch_reference).grid(row=13, column=2, sticky=NW)

        self.Luac_label = Label(self.FM1, text="Luac开关")
        self.Luac_label.grid(row=14, column=0, sticky=NW)
        self.luac_1 = Radiobutton(self.FM1, text='打开', variable=self.luac, value='true',
                                  command=self.print_luac).grid(row=14, column=1, sticky=NW)
        self.Luac_2 = Radiobutton(self.FM1, text='关闭', variable=self.luac, value='false',
                                  command=self.print_luac).grid(row=14, column=2, sticky=NW)

        self.start_button = Button(self.FM1, text="开始", width=10, command=self.call_pak)  # 调用内部方法  加()为直接调用
        self.start_button.grid(row=15, column=0, columnspan=2, sticky=NW)
        ...
        print("patch_config_path", patch_config_path)
    ...
    def call_pak(self):
        ...
        shader_type, need_reference, need_luac))
    ...
    def print_luac(self):
        self.write_log_to_Text('Set Luac: ' + self.luac.get())
